...
const (
	// Label holds the string label denoting the holdrelease type in the database.
	Label = "hold_release"
	...
	// Table holds the table name of the holdrelease in the database.
	Table = "hold_releases"
)

// Columns holds all SQL columns for holdrelease fields.
var Columns = []string{
	FieldID,
	FieldAccountID,
	FieldWorkspaceID,
...
// OrderOption defines the ordering options for the HoldRelease queries.
