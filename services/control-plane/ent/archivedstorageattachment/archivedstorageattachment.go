...
const (
	// Label holds the string label denoting the archivedstorageattachment type in the database.
	Label = "archived_storage_attachment"
	...
	// Table holds the table name of the archivedstorageattachment in the database.
	Table = "control_plane_archived_storage_attachments"
)

// Columns holds all SQL columns for archivedstorageattachment fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ArchivedStorageAttachment queries.
