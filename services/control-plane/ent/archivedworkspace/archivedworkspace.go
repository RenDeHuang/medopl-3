...
const (
	// Label holds the string label denoting the archivedworkspace type in the database.
	Label = "archived_workspace"
	...
	// Table holds the table name of the archivedworkspace in the database.
	Table = "control_plane_archived_workspaces"
)

// Columns holds all SQL columns for archivedworkspace fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ArchivedWorkspace queries.
