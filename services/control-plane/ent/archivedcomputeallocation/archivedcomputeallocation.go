...
const (
	// Label holds the string label denoting the archivedcomputeallocation type in the database.
	Label = "archived_compute_allocation"
	...
	// Table holds the table name of the archivedcomputeallocation in the database.
	Table = "control_plane_archived_compute_allocations"
)

// Columns holds all SQL columns for archivedcomputeallocation fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ArchivedComputeAllocation queries.
