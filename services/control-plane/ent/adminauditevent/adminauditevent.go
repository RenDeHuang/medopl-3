...
const (
	// Label holds the string label denoting the adminauditevent type in the database.
	Label = "admin_audit_event"
...
// Columns holds all SQL columns for adminauditevent fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the AdminAuditEvent queries.
