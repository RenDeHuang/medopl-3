...
func (oc *OrganizationCreate) SetBillingAccountID(s string) *OrganizationCreate {
	oc.mutation.SetBillingAccountID(s)
	return oc
}
...
func (oc *OrganizationCreate) createSpec() (*Organization, *sqlgraph.CreateSpec) {
	...
	if value, ok := oc.mutation.BillingAccountID(); ok {
