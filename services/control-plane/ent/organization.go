...
func (*Organization) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case organization.FieldID, organization.FieldBillingAccountID, organization.FieldName, organization.FieldStatus:
	...
	for i := range columns {
		...
		case organization.FieldBillingAccountID:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				o.BillingAccountID = value.String
			}
...
func (o *Organization) String() string {
	...
	builder.WriteString(o.BillingAccountID)
	builder.WriteString(", ")
