...
export const oplRoutes = Object.freeze([
  currentRoute({
    ...
    pageModule: "apps/console-ui/src/pages/HomePage.jsx",
  ...
  currentRoute({
    ...
    requiresAuth: false,
    routeKind: "auth_flow",
    pageModule: "apps/console-ui/src/pages/LoginPage.jsx",
    apiClient: "apps/console-ui/src/api/auth-api.js",
  ...
  currentRoute({
    ...
    menu: true,
    routeKind: "read_model",
    pageModule: "apps/console-ui/src/pages/OverviewPage.jsx",
  ...
  currentRoute({
    ...
    pageModule: "apps/console-ui/src/pages/resources/ResourceProvisioningPages.jsx",
  ...
  currentRoute({
    ...
    pageModule: "apps/console-ui/src/pages/workspaces/WorkspacesPage.jsx",
  ...
  currentRoute({
    ...
    routeKind: "business_object",
    objectKind: "Workspace",
    pageModule: "apps/console-ui/src/pages/workspaces/CreateWorkspacePage.jsx",
    apiClient: "apps/console-ui/src/api/workspaces-api.js",
  ...
  currentRoute({
    ...
    routeKind: "business_object",
    objectKind: "Workspace",
    pageModule: "apps/console-ui/src/pages/workspaces/WorkspaceDetailPage.jsx",
    apiClient: "apps/console-ui/src/api/workspaces-api.js",
    apiRoutes: [
      "GET /api/state",
  ...
  currentRoute({
    ...
    pageModule: "apps/console-ui/src/pages/gateway/GatewayPage.jsx",
  ...
  currentRoute({
    ...
    routeKind: "read_model",
    objectKind: "Wallet",
    pageModule: "apps/console-ui/src/pages/billing/BillingPage.jsx",
  ...
  currentRoute({
    ...
    routeKind: "read_model",
    objectKind: "User",
    pageModule: "apps/console-ui/src/pages/account/AccountPage.jsx",
    apiClient: "apps/console-ui/src/api/console-read-api.js",
  ...
  currentRoute({
    ...
    pageModule: "apps/console-ui/src/pages/support/SupportPage.jsx",
    apiClient: "apps/console-ui/src/api/support-api.js",
  ...
  currentRoute({
    ...
    pageModule: "apps/console-ui/src/pages/catalog/FabricPages.jsx",
    apiClient: "apps/console-ui/src/api/console-read-api.js",
    apiRoutes: ["GET /api/state", "GET /api/support/tickets"],
    serviceBoundary: "ConsoleReadModelService",
  ...
  currentRoute({
    ...
    adminMenu: true,
    routeKind: "read_model",
    pageModule: "apps/console-ui/src/pages/admin/AdminOverviewPage.jsx",
    apiClient: "apps/console-ui/src/api/console-read-api.js",
  ...
  currentRoute({
    ...
    objectKind: "Usage",
    pageModule: "apps/console-ui/src/pages/admin/AdminOverviewPage.jsx",
    apiClient: "apps/console-ui/src/api/ledger-api.js",
  ...
  currentRoute({
    ...
    hiddenInMenu: true,
    routeKind: "static_content",
    pageModule: "apps/console-ui/src/pages/shared/page-widgets.jsx",
    serviceBoundary: "ConsoleRouter"
  }),
  currentRoute({
    id: "error.notFound",
